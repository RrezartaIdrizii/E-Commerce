...
var images = ['./img/image1.jpg', './img/image1.jpg', './img/image1.jpg', './img/image2.jpg', './img/image2.jpg', './img/image2.jpg', './img/image3.jpg', './img/image3.jpg', './img/image3.jpg'];
var slideIndex = 0;
var isTransitioning = false;
function showSlide() {
  var startIndex = slideIndex * 3;
  var endIndex = startIndex + 3;
  var slideImages = images.slice(startIndex, endIndex);
  slider.innerHTML = '';
  for (var i = 0; i < slideImages.length; i++) {
    var img = document.createElement('img');
    img.src = slideImages[i];
    img.alt = "Photo ".concat(i + 1);
...
document.querySelector('form').addEventListener('submit', function (event) {
  ...
  var nameInput = document.querySelector('input[type="text"]').value;
